...
среди прочего:
   ...
   - [x] прошло больше часа с момента создания
   - [X] нигде не используется (essenceId/essenceTable пустые)
...
- [x] 7. Сделать возможность использовать файловый модуль в п.5
